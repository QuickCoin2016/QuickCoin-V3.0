...
int64 nChainStartTime = 1473498586;
...
const string strMessageMagic = "QuickCoin signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    int64 nSubsidy = 2 * nCoinAge * nRewardCoinYear / 365;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in QuickCoin
    bool fStrictPayToScriptHash = true; // Always active in QuickCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "QuickCoin",CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "QuickCoinV3 Launches. zaobi.org qq260682605";
...
//        CTransaction txNew(1, 1393221600, vin, vout, 0);
        ...
        assert(block.hashMerkleRoot == uint256("6e10bc1ec77bf93a4e3d25c1e4023da05f48df84f1e796686e96d118231e4be7"));
