...
static const char *strDNSSeed[][2] = {
    {"dnsseed31","47.89.24.42"},
    {"dnsseed32","47.88.214.201"},
    {"dnsseed33","121.42.193.95"},
    {"dnsseed34","114.55.100.18"},
    {"dnsseed35","47.89.181.89"},
    {"dnsseed36","47.91.72.228"},
    ...
    {"node4","115.28.94.224"},
    {"node5","115.28.80.117"},
    {"node6","114.215.187.177"},
    {"newseed","47.90.8.201"},
    {"newseed","47.88.139.100"},
    {"newseed","121.42.155.220"},
    {"newseed","121.41.94.189"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. QuickCoin is probably already running."), addrBind.ToString().c_str());
        else
